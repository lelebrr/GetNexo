            ...
            {modalOpen && (
                <div className="fixed inset-0 z-[1001] flex items-center justify-center p-4">
                    ...
                    <div className="glass-panel w-full max-w-xl p-10 relative bg-[#0a0e17] border-[#00d4ff]/20 shadow-[0_0_100px_rgba(0,212,255,0.1)]">
                        <button onClick={() => setModalOpen(false)} aria-label="Fechar" className="absolute top-6 right-6 text-gray-500 hover:text-white text-2xl focus-visible:ring-2 focus-visible:outline-none rounded">✕</button>
