                ...
                <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-[100] backdrop-blur-sm">
                    <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 w-[90%] max-w-4xl h-[80vh] flex flex-col">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <button aria-label="Fechar" onClick={() => setSelectedContainer(null)} className="text-2xl hover:text-white text-gray-500 focus-visible:ring-2 focus-visible:outline-none rounded">✕</button>
                        </div>
