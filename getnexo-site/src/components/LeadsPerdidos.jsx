                    ...
                    <div className="bg-gray-900 rounded-xl w-full max-w-lg border border-gray-800">
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <button onClick={fecharModal} aria-label="Fechar" className="text-gray-400 hover:text-white text-2xl focus-visible:ring-2 focus-visible:outline-none rounded">✕</button>
                            </div>
