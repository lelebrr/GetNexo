        ...
        <div className="absolute inset-0 bg-black/80 backdrop-blur-md z-50 flex items-center justify-center p-4">
            <div className="bg-gray-900 border border-gray-700 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col h-[70vh]">
                <div className="p-4 border-b border-gray-800 flex justify-between items-center bg-gray-900">
                    ...
                    <button onClick={onClose} className="text-gray-500 hover:text-white" aria-label="Fechar">✕</button>
                </div>
                            ...
                            {cart.map((item, idx) => (
                                <div key={idx} className="flex justify-between items-center text-sm border-b border-gray-800 pb-2">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <button onClick={() => removeFromCart(idx)} className="text-red-500 hover:text-red-400" aria-label="Remover item">✕</button>
                                    </div>
                                </div>
                            ))}
                        </div>
