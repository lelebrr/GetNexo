        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <div className="bg-gray-900 border border-gray-800 w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-zoom-in">
                <div className="p-6 border-b border-gray-800 flex justify-between items-center bg-black/20">
                    ...
                    <button onClick={onClose} aria-label="Fechar agendamento" className="text-gray-500 hover:text-white transition-colors text-2xl focus-visible:ring-2 focus-visible:outline-none rounded">✕</button>
                </div>

                <form onSubmit={handleSchedule} className="p-6 space-y-4">
                    <div>
                        <label htmlFor="assunto" className="block text-xs font-bold text-gray-500 uppercase mb-1">Assunto <span className="text-red-500">*</span></label>
                        <input
                            id="assunto"
                            required
                            value={summary}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label htmlFor="data" className="block text-xs font-bold text-gray-500 uppercase mb-1">Data <span className="text-red-500">*</span></label>
                            <input
                                id="data"
                                required
                                type="date"
                        ...
                        <div>
                            <label htmlFor="hora" className="block text-xs font-bold text-gray-500 uppercase mb-1">Hora <span className="text-red-500">*</span></label>
                            <input
                                id="hora"
                                required
                                type="time"
