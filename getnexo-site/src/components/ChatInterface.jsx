                        ...
                        <div className="p-4 border-b border-gray-800 bg-black/40 backdrop-blur-md flex justify-between items-center z-10">
                            ...
                            <div className="flex gap-2">
                                <div className="flex gap-2 relative">
                                    ...
                                    <button onClick={() => setShowCsat(!showCsat)} aria-expanded={showCsat} aria-controls="csat-popup" className="text-xs bg-gray-800 text-gray-300 hover:text-white hover:bg-gray-700 px-3 py-1 rounded border border-gray-600 transition-colors">
                                        ⭐ CSAT
                                    </button>
                                    {showCsat && (
                                        <div id="csat-popup" className="absolute top-10 right-0 w-64 bg-gray-900 border border-gray-700 p-4 rounded-xl shadow-2xl z-50">
