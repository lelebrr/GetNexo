...
const ContactItem = React.memo(({ contact: c, isActive, onClick, onDragStart }) => (
    <button
        ...
        className={`w-full text-left p-3 rounded-xl cursor-pointer transition-all border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neon-blue ${isActive ? 'bg-neon-blue/10 border-neon-blue' : 'bg-transparent border-transparent hover:bg-gray-800'} flex items-center gap-3 group`}
