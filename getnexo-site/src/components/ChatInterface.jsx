                        ...
                        <div className="p-4 border-b border-gray-800 bg-black/40 backdrop-blur-md flex justify-between items-center z-10">
                            ...
                            <div className="flex gap-2">
                                <div className="flex gap-2 relative">
                                    ...
                                    <button
                                        onClick={() => setShowCsat(!showCsat)}
                                        aria-expanded={showCsat}
                                        aria-controls="csat-popup"
                                        className="text-xs bg-gray-800 text-gray-300 hover:text-white hover:bg-gray-700 px-3 py-1 rounded border border-gray-600 transition-colors"
                                    >
                                        ⭐ CSAT
                                    </button>
                                    {showCsat && (
