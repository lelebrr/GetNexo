            ...
            {activeContact && showRightSidebar && (
                <div className="w-1/4 flex flex-col glass-panel rounded-2xl border border-gray-800 animate-slide-in-right">
                    <div className="p-4 border-b border-gray-800 flex justify-between items-center">
                        ...
                        <button onClick={() => setShowRightSidebar(false)} aria-label="Fechar detalhes do contato" className="text-gray-500 hover:text-white focus-visible:ring-2 focus-visible:outline-none rounded">
                            <span aria-hidden="true">✕</span>
                        </button>
                    </div>
