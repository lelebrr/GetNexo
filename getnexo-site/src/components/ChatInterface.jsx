...
export const ContactItem = React.memo(({ contact: c, isActive, onClick, onDragStart }) => (
    <button
        ...
        className={`w-full text-left p-3 rounded-xl cursor-pointer transition-all border ${isActive ? 'bg-neon-blue/10 border-neon-blue' : 'bg-transparent border-transparent hover:bg-gray-800'} flex items-center gap-3 group focus:outline-none focus:ring-2 focus:ring-neon-blue`}
    >
