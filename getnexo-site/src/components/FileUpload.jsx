                                    ...
                                    <div className="aspect-square bg-gray-900 relative">
                                        ...
                                        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity flex items-center justify-center gap-2">
                                            <a
                                                ...
                                                className="p-2 bg-neon-blue text-black rounded-full hover:scale-110 transition-transform outline-none focus:ring-2 focus:ring-white"
                                            >
                                                👁️
                                            </a>
                                            <button
                                                ...
                                                className="p-2 bg-red-500 text-white rounded-full hover:scale-110 transition-transform outline-none focus:ring-2 focus:ring-white"
                                            >
                                                🗑️
                                            </button>
                                        </div>
