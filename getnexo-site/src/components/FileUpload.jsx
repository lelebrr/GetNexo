                                ...
                                <div key={index} className="group bg-black/40 border border-gray-800 rounded-xl overflow-hidden hover:border-gray-600 transition-all">
                                    <div className="aspect-square bg-gray-900 relative">
                                        ...
                                        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity flex items-center justify-center gap-2">
                                            <a href={file.url} target="_blank" aria-label={`Visualizar ${file.name}`} className="p-2 bg-neon-blue text-black rounded-full hover:scale-110 transition-transform">👁️</a>
                                            <button onClick={() => handleDelete(file.name)} aria-label={`Deletar ${file.name}`} className="p-2 bg-red-500 text-white rounded-full hover:scale-110 transition-transform">🗑️</button>
                                        </div>
                                    </div>
                                    <div className="p-3">
