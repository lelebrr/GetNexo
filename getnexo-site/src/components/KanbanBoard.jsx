            ...
            {hasInsight && (
                <div className="mb-3 p-3 bg-purple-900/20 border border-purple-500/30 rounded-lg animate-fade-in">
                    <div className="flex justify-between items-start mb-1">
                        ...
                        <button aria-label="Fechar insight da IA" onClick={() => onToggleInsight(contact.id)} className="text-[10px] text-gray-500 hover:text-white focus-visible:ring-2 focus-visible:outline-none rounded">✕</button>
                    </div>
