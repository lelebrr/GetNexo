                    ...
                    <div key={i} className={`flex ${m.user ? 'justify-end' : 'justify-start'}`}>
                        <div className={`max-w-[85%] px-4 py-3 rounded-2xl ${m.user ? 'bg-green-600/80' : 'bg-gray-800/60'} text-white`}>
                            ...
                            <button
                                ...
                                className="ml-2 inline-flex items-center text-xs bg-black/40 px-2 py-1 rounded-full hover:bg-black/60 transition focus-visible:ring-2 focus-visible:ring-cyan-400 focus:outline-none"
