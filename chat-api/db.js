...
const initSchema = () => {
  ...
  // Create performance indexes to avoid full table scans on analytical endpoints
  const indexes = [
    ...
    'CREATE INDEX IF NOT EXISTS idx_security_events_created_at_type ON security_events(created_at, type)',
