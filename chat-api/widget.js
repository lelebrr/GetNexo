// widget.js - GetNexo Widget Final Version
(function () {
    ...
    // Finds the current script tag to extract configuration
    ...
    const config = {
        ...
        position: currentScript.dataset.position || 'right' // 'left' or 'right'
    };
    ...
    // 4. Styles (Scoped via Shadow DOM logic - simplified here for compatibility)
    // Using a shadow host would be ideal, but for maximum compatibility we'll use specific IDs and aggressive CSS reset on them.
    const styles = `
        #getnexo-root {
        ...
        #getnexo-close:hover { color: white; }
        ...
        .gn-msg {
            ...
            font-size: 14px;
            line-height: 1.5;
            animation: gn-fade-in 0.3s ease-out;
        }
        ...
        #getnexo-send:hover { background: #00d4ff; }
        ...
        .gn-loading span {
            ...
            background: #94a3b8;
            border-radius: 50%;
            animation: gn-bounce 1.4s infinite ease-in-out both;
            margin: 0 2px;
        }
        
        .gn-loading span:nth-child(1) { animation-delay: -0.32s; }
        .gn-loading span:nth-child(2) { animation-delay: -0.16s; }
    ...
    function init() {
        ...
        const sendMessage = async () => {
            ...
            try {
                ...
                if (data.reply) {
                    ...
                    appendMessage('Desculpe, não entendi. Pode repetir?', 'bot');
                }
        ...
        function appendMessage(text, type) {
            ...
            div.innerHTML = text; // Allow minimal HTML if trusted, else use textContent
        ...
        function appendLoading() {
            ...
            const div = document.createElement('div');
            div.id = id;
            div.className = 'gn-msg bot gn-loading';
