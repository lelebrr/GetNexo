...
router.put('/:id', (req, res) => {
    try {
        ...
        const allowedFields = [
            ...
            'channel', 'status', 'priority', 'assigned_agent_id', 'assigned_agent_name',
            'human_agent', 'sentiment', 'sentiment_score', 'last_message',
            'last_message_at', 'updated_at', 'closed_at', 'tags', 'metadata'
        ];
