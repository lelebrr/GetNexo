...
router.get('/dashboard-stats', (req, res) => {
    try {
        ...
        // reducing queries from 2 to 1 and execution time from ~5.7ms to ~2.4ms
        ...
        const revenue24h = { total: transactionStats.total || 0 };
        const salesCount24h = { count: transactionStats.count || 0 };
