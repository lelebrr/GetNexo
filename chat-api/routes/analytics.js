...
router.get('/dashboard-stats', (req, res) => {
    try {
        // ⚡ Bolt: Combines revenue and sales count into a single query to reduce database roundtrips by 50%
        // Impact: reducing queries from 2 to 1 (full table scans on transactions).
