...
router.get('/stats', (req, res) => {
    try {
        ...
        // Combine multiple sequential COUNT(*) queries into single queries using conditional aggregation
        // Impact: reducing queries from 8 to 4
        ...
        res.json({
            ...
            peers: {
                total: peersData.total || 0,
                trusted: peersData.trusted || 0
            },
