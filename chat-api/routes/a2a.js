...
router.get('/stats', (req, res) => {
    try {
        // Bolt: Combined sequential COUNT(*) queries using conditional aggregation, reducing table scans from 3 to 1 for tasks, 2 to 1 for messages, and 2 to 1 for peers.
