...
router.get('/stats', (req, res) => {
    try {
        // ⚡ Bolt: Combine multiple sequential COUNT(*) queries on the same tables into single queries
        // using conditional aggregation. This reduces SQLite table scans from 7 queries to 3 queries (O(N) to O(1) ops).
