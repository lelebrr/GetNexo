...
router.get('/analytics/dashboard', (req, res) => {
    try {
        // ⚡ Bolt: Optimized sequential COUNT(*) queries into a single query using conditional aggregation
        // This avoids multiple full table scans and reduces database latency
