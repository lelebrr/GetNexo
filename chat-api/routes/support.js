...
router.get('/analytics/dashboard', (req, res) => {
    try {
        ...
        // Combine 5 sequential COUNT(*) queries into a single query using conditional aggregation
        // Impact: Reduces database latency and table scans from 5 to 1.
        const query = `
            SELECT
                COUNT(*) as total,
...
router.get('/admin/stats', (req, res) => {
    try {
        ...
        // ⚡ Bolt: Performance optimization
        // Combine 6 sequential COUNT(*) queries into a single query using conditional aggregation
        // Impact: Reduces database latency and table scans from 6 to 1.
        const query = `
            SELECT
                COUNT(*) as total,
                SUM(CASE WHEN status = 'open' THEN 1 ELSE 0 END) as open,
