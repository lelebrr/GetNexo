...
router.get('/analytics/dashboard', (req, res) => {
    try {
        // ⚡ Bolt: Optimizing multiple COUNT queries into a single pass using conditional aggregation
        // This reduces database queries from 5 to 1, significantly improving performance for analytics dashboard
...
router.get('/admin/stats', (req, res) => {
    try {
        ...
        // ⚡ Bolt: Optimizing multiple COUNT queries into a single pass using conditional aggregation
        // This reduces database queries from 6 to 1, significantly improving performance for admin stats
        const row = db.prepare(`
            SELECT
                COUNT(*) as c,
                SUM(CASE WHEN status = 'open' THEN 1 ELSE 0 END) as open,
