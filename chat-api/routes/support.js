...
router.get('/analytics/dashboard', (req, res) => {
    try {
        // ⚡ Bolt Optimization: Replacing 5 sequential SELECT COUNT(*) queries with a single conditional aggregation query.
        // This reduces SQLite parser overhead, limits disk IO, and avoids 4 extra database round-trips.
...
router.get('/admin/stats', (req, res) => {
    try {
        ...
        // ⚡ Bolt Optimization: Replacing 6 sequential SELECT COUNT(*) queries with a single conditional aggregation query.
        // This reduces SQLite parser overhead, limits disk IO, and avoids 5 extra database round-trips.
        const row = db.prepare(`
            SELECT
                COUNT(*) as total,
                SUM(CASE WHEN status = 'open' THEN 1 ELSE 0 END) as open,
