...
router.get('/analytics/dashboard', (req, res) => {
    try {
        ...
        const stats = {
            ...
            open: statsQuery.open || 0,
            inProgress: statsQuery.inProgress || 0,
            closed: statsQuery.closed || 0,
            highPriority: statsQuery.highPriority || 0
        };
...
router.get('/admin/stats', (req, res) => {
    try {
        ...
        const stats = {
            ...
            closed: statsQuery.closed || 0,
            highPriority: statsQuery.highPriority || 0,
            todayNew: statsQuery.todayNew || 0,
