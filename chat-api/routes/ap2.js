...
router.get('/stats', (req, res) => {
    try {
        // ⚡ Bolt Optimization: Combined 3 queries on ap2_mandates into 1 using conditional aggregation
        // Measured Impact: Algorithmic shift from multiple O(N) full table scans to a single scan.
        ...
        const mandateCount = mandateStats.total || 0;
